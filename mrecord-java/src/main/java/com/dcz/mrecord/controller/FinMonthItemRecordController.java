...
public class FinMonthItemRecordController {
    ...
    public Result<List<FinMonthItemRecord>> insertMonthItem(MonthItemDTO monthItemDTO) {
    ...
    public Result<List<FinMonthItemRecord>> updateMonthItem(MonthItemDTO monthItemDTO) {
    ...
    public Result<List<FinMonthItemRecord>> queryMonthItem(MonthItemDTO monthItemDTO) {
    ...
    public Result<Map<String, List<FinMonthItemRecord>>> queryAllMonthItem(MonthItemDTO monthItemDTO) {

...
/// 导出任务列表查询请求。
///
/// 对应 Java: `ExportTaskController.list` 入参。
#[derive(Deserialize)]
...
pub struct QueryExportTaskDto {
    ...
    #[serde(flatten)]
    pub page: PageInfo,
    /// 任务状态（WAIT/RUN/SUCCESS/FAIL），为空则查询全部状态
...
impl From<crate::entity::sys_export_task::Model> for ExportTaskResponse {
    fn from(m: crate::entity::sys_export_task::Model) -> Self {
        Self {
            id: m.id,
            book_id: m.book_id,
